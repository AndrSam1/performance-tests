...
class ExistingUserIssueVirtualCardSeedsScenario(SeedsScenario):
    """
    Сценарий сидинга для существующего пользователя, который загружает свои счета,
    просматривает дебетовый счет, затем выполняет выпуск виртуальной карты для своего дебетового счета.
