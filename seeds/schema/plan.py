...
class SeedAccountsPlan(BaseModel):
    ...
    Attributes:
        ...
        transfer_operations (eedOperationResult): План по созданию операций перевода.
        cash_withdrawal_operations (SeedOperationResult): План по созданию операций снятия наличных.
    """
    count: int = 0
